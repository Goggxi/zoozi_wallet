...
class _WithdrawalPageState extends State<WithdrawalPage>
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildWithdrawalForm(wallet, l, theme, isDark),
                      const SizedBox(height: 24),
        ...
        gradient: isDark
            ? LinearGradient(
                ...
                colors: [
                  ...
                  Colors.redAccent.withAlpha((0.2 * 255).round()),
                ],
              )
  ...
  Widget _buildQuickAmountButtons(WalletModel wallet, ThemeData theme) {
    ...
    final quickAmounts = [
      ...
      balance * 0.75, // 75%
      balance, // All
    ].where((amount) => amount >= _minAmount).toList();
      ...
      children: [
        ...
        Wrap(
          ...
          children: quickAmounts.asMap().entries.map((entry) {
            ...
            final percentage = [25, 50, 75, 100][index];
  ...
  Widget _buildProceedButton(WalletModel wallet, dynamic l, ThemeData theme) {
    final canWithdraw = wallet.balance >= _minAmount;

    return SizedBox(
      width: double.infinity,
      height: 56,
      child: ElevatedButton(
        onPressed: _isProcessing || !canWithdraw
            ? null
            : () => _proceedWithdrawal(wallet, l),
        style: ElevatedButton.styleFrom(
          backgroundColor: canWithdraw ? Colors.red : Colors.grey,
          ...
          shadowColor:
              canWithdraw ? Colors.red.withAlpha((0.3 * 255).round()) : null,
        ),
        child: _isProcessing
            ? Row(
            ...
            : Text(
                canWithdraw ? l.proceed : l.insufficientBalance,
                style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ),
  ...
  void _proceedWithdrawal(WalletModel wallet, dynamic l) {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Remaining balance: ${Currency.getSymbol(wallet.currency)}${(wallet.balance - amount).toStringAsFixed(2)}',
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pop();
                    _executeWithdrawal(wallet, amount, description, reference);
                  },
                  style: ElevatedButton.styleFrom(
  ...
  void _executeWithdrawal(
    ...
    _walletBloc.add(CreateWithdrawalEvent(
      walletId: wallet.id!,
      amount: amount,
